    ...
    get: {
      parameters: {
        query: {
          ...
          testNumber?: parameters["rowFilter.test.testNumber"];
          "Mit Leerzeichen"?: parameters["rowFilter.test.Mit Leerzeichen"];
          /** Filtering Columns */
          select?: parameters["select"];
          /** Ordering */
          order?: parameters["order"];
...
export interface parameters {
  ...
  /** Format: real */
  "rowFilter.test.testNumber": string;
  /** Format: character varying */
  "rowFilter.test.Mit Leerzeichen": string;
  /** @description users */
